...
import pytest
from enclave_guard.models import FrontierPayload, ExecutionStatus
from enclave_guard.engine import FrontierDomainEngine
from enclave_guard.agents import QuoteSignatureVerifierAgent, EnclaveMeasurementAuditorAgent, AttestedTLSHandshakeAgent, EnclaveGuardCoordinator
from enclave_guard.cli import main


def test_sub_agents():
    a1 = QuoteSignatureVerifierAgent()
    ...
    a2 = EnclaveMeasurementAuditorAgent()
...
def test_coordinator():
    ...
    assert "Intel SGX ECDSA Attestation / AMD SEV-SNP" in ans or "specifications" in ans
