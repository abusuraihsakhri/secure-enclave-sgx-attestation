"""
Command Line Interface for Secure Enclave Sgx Attestation.
"""
import argparse
import csv
import json
...
def main(argv=None):
    parser = argparse.ArgumentParser(prog="secure-enclave-sgx-attestation", description="Secure Enclave Sgx Attestation")
    ...
    if args.command == "audit":
        ...
        print("=" * 80)
        print(f"  SECURE ENCLAVE SGX ATTESTATION")
    ...
    if args.command == "chat":
        ...
        print(f"\n[Secure Enclave Sgx Attestation Supervisor]:\n{ans}\n")
        return 0
    ...
    if args.command == "serve":
        ...
        print(f"Starting Secure Enclave Sgx Attestation API server on http://{args.host}:{args.port}")
