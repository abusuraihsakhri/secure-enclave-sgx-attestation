"""
Data Models & Telemetry Definitions for EnclaveGuard: Intel SGX / AMD SEV Remote Attestation & Quoting Agent.
...
class AgentTelemetryAlert:
    ...
    standard_reference: str = "Intel SGX ECDSA Attestation / AMD SEV-SNP"
    timestamp: str = field(default_factory=lambda: datetime.datetime.now(datetime.timezone.utc).isoformat())
